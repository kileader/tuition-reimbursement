...
public class Database {
	...
	private static final Logger logger = Logger.getLogger(GenericRepoImpl.class);
	...
	**/
    ...
    private void loadProperties() {
        ...
        try {
            ...
            logger.error("Database.loadProperties()...Exception: ", e);
        }
    ...
    public void disconnect() {
        if (connection != null) {
            try {
                ...
                logger.error("Database.disconnect()...SQLException: ", e);
            }
        }
    ...
    public void runSQL(String sqlFile) {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(classloader.getResourceAsStream(sqlFile))))  {
            ...
            logger.error("Database.runSQL()...SQLException: ", se);
        } catch (Exception e) {
            logger.error("Database.runSQL()...Exception: ", e);
        } finally {
            disconnect();
        }
