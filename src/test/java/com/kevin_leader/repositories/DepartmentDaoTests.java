...
public class DepartmentDaoTests {
	...
	public void addSuccess() {
		Employee employee = new Employee("Super", "Saiyan",
				"eleven@gohan.com", "3j1o5ino1!", null, null, null, null);
	...
	public void getAllSuccess() {
		...
		assertTrue(1 < departments.size() && departments.size() < 5);
	}
	...
	public void updateSuccess() {
		Employee employee = new Employee("Super", "Saiyan",
				"rotund@vegeta.com", "3j1o5ino1!", null, null, null, null);
	...
	public void deleteSuccess() {
		...
		assertEquals(deletedDepartment.toString(), updatedDepartment.toString());
	}
